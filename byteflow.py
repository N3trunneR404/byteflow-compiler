...
def process_args():
    ...
    parser.add_argument("--output", "-o", metavar="output_file", nargs=1, help="Path to output Byteflow file")
    parser.add_argument("--run", "-r", action="store_true", help="Run the Byteflow file after compilation")
